...
public class StateMachine<TOwner>
{
    ...
    public abstract class State
    {
        ...
        internal async UniTask EnterAsync(State currentState, CancellationToken token)
        {
    ...
    public void Start(State firstState, CancellationToken token)
    {
        ...
        CurrentState.EnterAsync(null, token).Forget();
    }
    ...
    public void Change(State nextState, CancellationToken Token)
    {
        ...
        nextState.EnterAsync(null, Token).Forget();
    }
}
